  ...
  const portalRows = useMemo(() => {
    ...
    students.forEach((s) => {
      ...
      rows.push({
        ...
        portalType: "parent",
        status: s.parentDisplayStatus ?? (s.parentGrant ? s.parentGrant.status : "not_generated"),
      ...
      rows.push({
        ...
        studentClass: s.studentClass,
        portalType: "student",
        status: s.studentDisplayStatus ?? (s.studentGrant ? s.studentGrant.status : "not_generated"),
